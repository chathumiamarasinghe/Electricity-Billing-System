...
public class BillController {
    ...
    public void insertBill(int bill_id, int customer_id, int starting_meter_reading, int ending_meter_reading, LocalDateTime start_date, LocalDateTime end_date, 
            int units_consumed, double total_cost)
    {
